			...
			<div class="list inset">
				<a class="list-item" data-toggle="modal" data-target="#chat" data-dismiss="modal">
		            <span class="list-left">
		            	<span class="avatar">
		                	...
		                	<img src="<?php echo get_template_directory_uri(); ?>/_include/images/a1.jpg" class="w-20" alt=".">
		                </span>
		            </span>
	            ...
	            <a class="list-item" data-toggle="modal" data-target="#chat" data-dismiss="modal">
		            <span class="list-left">
		            	<span class="avatar">
		            		<i class="on avatar-center no-border"></i>
		                	<img src="<?php echo get_template_directory_uri(); ?>/_include/images/a2.jpg" class="w-20" alt=".">
		                </span>
		            </span>
		            <span class="list-body text-ellipsis">
		            	Crystal Guerrero
	            ...
	            <a class="list-item" data-toggle="modal" data-target="#chat" data-dismiss="modal">
		            <span class="list-left">
		            	<span class="avatar">
		            		<i class="on avatar-center no-border"></i>
		                	<img src="<?php echo get_template_directory_uri(); ?>/_include/images/a3.jpg" class="w-20" alt=".">
		                </span>
		            </span>
		            <span class="list-body text-ellipsis">
		            	Judith Garcia
	            ...
	            <a class="list-item" data-toggle="modal" data-target="#chat" data-dismiss="modal">
		            <span class="list-left">
		            	<span class="avatar">
		                	...
		                	<img src="<?php echo get_template_directory_uri(); ?>/_include/images/a4.jpg" class="w-20" alt=".">
		                </span>
		            </span>
		            <span class="list-body text-ellipsis">
		            	Melissa Garza
	            ...
	            <a class="list-item" data-toggle="modal" data-target="#chat" data-dismiss="modal">
		            <span class="list-left">
		            	<span class="avatar">
		                	...
		                	<img src="<?php echo get_template_directory_uri(); ?>/_include/images/a5.jpg" class="w-20" alt=".">
		                </span>
		            </span>
		            <span class="list-body text-ellipsis">
		            	Douglas Torres
...
<div class="modal fade inactive" id="chat" data-backdrop="false">
  <div class="modal-left w-xxl dark-white b-l">
  	  <div class="row-col">
  	    ...
  	    <div class="row-row light">
  	      <div class="row-body scrollable hover">
  	        <div class="row-inner">
  	          <div class="p-a-md">
  	            <div class="m-b">
  	              <a href="#" class="pull-left w-40 m-r-sm"><img src="<?php echo get_template_directory_uri(); ?>/_include/images/a2.jpg" alt="..." class="w-full img-circle"></a>
  	              <div class="clear">
  	            ...
  	            <div class="m-b">
  	              <a href="#" class="pull-right w-40 m-l-sm"><img src="<?php echo get_template_directory_uri(); ?>/_include/images/a3.jpg" class="w-full img-circle" alt="..."></a>
